...
export function TrailheadsPage() {
  ...
  return (
    <section className="page container">
      ...
      {methodology && <section className="map-methodology" aria-labelledby="map-methodology-title"><h2 id="map-methodology-title">{methodology.title}</h2><MarkdownContent markdown={methodology.body} /></section>}
    </section>
  )
}
